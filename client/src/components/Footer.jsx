      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <p className="text-slate-500 text-sm leading-relaxed max-w-sm">
              Software-based CDN & Reverse Proxy Service. Deploy your reverse proxy in seconds and route traffic through 72+ countries.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#pricing" className="text-sm text-slate-500 hover:text-cyan-400 transition-colors">Pricing</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://discord.gg/mg6q9mgA" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-cyan-400 transition-colors" title="Discord">
              <DiscordIcon />
            </a>
            <a href="mailto:support@proxyxpass.com" className="text-slate-600 hover:text-cyan-400 transition-colors" title="Email">
