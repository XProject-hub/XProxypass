...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="absolute top-1/3 -right-32 w-[400px] h-[400px] rounded-full bg-cyan-500/[0.05] blur-[120px] animate-float" />
      <div className="absolute bottom-1/3 -left-32 w-[300px] h-[300px] rounded-full bg-blue-600/[0.05] blur-[120px] animate-float-delayed" />
